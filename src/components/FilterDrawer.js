            ...
            >
                <div className="filter-wrapper">
                    ...
                    <main>
                        <div>
                            <section className="py-[15px] pl-[20px] pr-[20px]">
                                <div className="flex justify-between">
                                    <h3>지역</h3><button onClick={handleReset}>초기화</button>
                                </div>
                                ...
                                <div className="flex hotplace-wrapper">
                                    {hotplaces.map((item,index) => {
                                        return(
                                            <button
                                                className={`${isCities == "서울 전체" ? "active" : isCities == item.name ? "active" : ""}`}
                        ...
                        <div>
                            <section className="py-[15px] pl-[20px] pr-[20px]">
                                <div className="flex justify-between"><h3>가격</h3><button>초기화</button></div>
                                    asdasdasdasda
                            </section>
                        </div>
                    </main>
