      ...
      >
        <DrawerContents className="drawer-box">
          ...
          <div className="drawer-box-body">
            <div className="font-16 color-gray mb-[24px]">
              방문 일정을 다시 한번 확인해 주세요.
            </div>
                ...
                <div className="detail-box-body">
                  <div className="options-with-icon">
                    ...
                    <div className="people">
                      {detail ? detail.people + "명" : ""}
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <div className="font-16 color-gray">
              당일취소 및 노쇼는 레스토랑뿐만 아니라 다른 고객님께도 피해가 될
              수 있으므로 신중히 예약 부탁드립니다.
            </div>
          </div>
          <div className="drawer-box-footer">
            <div className="btn-group">
              <button
                className="confirm-close btn btn-lg btn-outline"
                open={isConfirmOpen}
                onClick={onClose}
              >
                취소
              </button>
              <button className="btn btn-lg btn-red" onClick={onReserve}>
                확인
              </button>
            </div>
          </div>
