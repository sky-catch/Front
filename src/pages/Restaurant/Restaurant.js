...
const shopImgItem = {
    id: 0,
    name : '본디',
    detail : '비장탄 숯을 이용한 돼지 생갈비, 즉석 양념갈비, 장작으로 구워낸 껍데기 맛이 일품인 곳',
    star : 4.7,
    tags : '돼지고기구기 | 석촌',
    shopImg : [
      {
      ...
      <div>
        <section className='waiting'>
          ...
          <div className='section-body'>
            <div className='mb-[8px]' onClick={openDrawerBottom}><a href="#" className='btn btn-lg btn-outline btn-cta full-width arrowdown'>
              <span><span className='label calendar'>오늘 (월) / 2 명</span></span>
            </a></div>
            <div></div>
            <div></div>
          </div>
