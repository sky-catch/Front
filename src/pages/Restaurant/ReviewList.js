        ...
        <div className="container gutter-sm">
          <div className="review-rating-summary review-rating-summary-splitview flex mt-[24px]">
            <div className="average">
              <h5>
                <span>{commentCount}개 리뷰 별점 평균</span>
              </h5>
              <div className="scoring">
                <strong>
                  {restaurant
                    ? restaurant.reviewAvg >= 5
                      ? "5.0"
                      : restaurant.reviewAvg.toFixed(1)
                    : ""}
                </strong>
              </div>
            </div>
                  ...
                  return (
                    <li key={i}>
                      ...
                      <span className="progress">
                        <span
                          className="bar"
                          style={{ width: `${counts ? counts[4 - i] : 0}%` }}
                        ></span>
                      </span>
          ...
          <div className="container gutter-sm">
            <div className="section-body">
              {restaurant.reviewComments.map((item, index) => {
                return <ReviewItem key={index} info={item} />;
              })}
            </div>
          </div>
        </section>
